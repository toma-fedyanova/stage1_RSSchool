...
const taskText: Record<string, InfoTask> = {
  ...
  task: 'Задание: выберите всех животных на дороге.'},
  '2': {
  ...
  task: 'Задание: выберите всех котов на дороге'},
  '3': {
  ...
  task: 'Задание: выберите птицу на дороге'},
  '4': {
  ...
  task: 'Задание: выберите всех собак на дороге'},
  '5': {
  ...
  task: 'Задание: выберите всех животных с именем, заканчивающимся на "акс".'}, //макс, бакс
  '9': {
  title: 'Псевдоклассы.',
  ...
  task: 'Задание: выберите животного, которое отключено(disabled).'},
  '10': {
  ...
  task: 'Задание: выберите животного, не собаку, используя конструкцию :not.'}, //car :not(dog) 
}
